...
from account.models import CustomUser, OTP, Wishlist
from account.serializers import CustomUserSerializer, MyTokenObtainPairSerializer, SendOTPSerializer, CheckOTPSerializer, ResetPasswordSerializer, ChangePasswordSerializer, WishlistSerializer, WishlistDocsSerializer
